...
class TestIndexPage(unittest.TestCase):
    ...
    def test_pdf_download_buttons(self):
        # Index offers both bilingual PDF downloads (generated by deploy CI).
        self.assertIn('href="generic-agent-visual-guide-zh.pdf"', self.html)
        self.assertIn('href="generic-agent-visual-guide-en.pdf"', self.html)
